 ...
 * @author welcome
 */
public class ElectionResultsForVoterAndCandidate extends JFrame {
    ...
    public ElectionResultsForVoterAndCandidate() {
        initComponents();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElectionResultsForVoterAndCandidate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        /* Create and display the form */
        EventQueue.invokeLater(() -> new ElectionResultsForVoterAndCandidate().setVisible(true));
    }
