...
public class CreateElection extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("To Create New Election");
        ...
        jButton16.setText("Update Election Details");
        ...
        jButton18.setText("Remove Election");
        ...
        jLabel10.setText("Election_Name");
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        if (electionId.isEmpty() || electionName.isEmpty() || startDate.isEmpty() || endDate.isEmpty()) {
            ...
            try {
                ...
                pst.setTimestamp(2, Timestamp.valueOf(startDate)); // Start time
                pst.setTimestamp(3, Timestamp.valueOf(endDate)); // End time
                pst.setString(4, electionId); // ID

                pst.executeUpdate();
                JOptionPane.showMessageDialog(this, "Election information updated successfully");
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        ...
        try {
            String id = RecordTable.getValueAt(SelectedRows, 1).toString();
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        jTextArea1.setText(RecordTable.getValueAt(SelectedRows, 5).toString());
